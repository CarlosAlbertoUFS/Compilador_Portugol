...
public final class AMenorIgualSimbolo2 extends PSimbolo2
{
    private TMenorIgual _menorIgual_;

    public AMenorIgualSimbolo2()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMenorIgualSimbolo2(
    ...
    {
        ((Analysis) sw).caseAMenorIgualSimbolo2(this);
    }
